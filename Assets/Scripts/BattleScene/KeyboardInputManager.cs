...
public class KeyboardInputManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // if (Input.GetKey(KeyCode.RightArrow)) playerController.OnMove(1.0f);
        // else if (Input.GetKey(KeyCode.LeftArrow)) playerController.OnMove(-1.0f);
        // else playerController.OnMove(0);

        // //
        // if (Input.GetKeyDown(KeyCode.Z)) playerController.OnAttack1();
    }
}
